...
/*   Updated: 2026/02/21 14:45:51 by yafakihi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				**allocate_and_collect(int argc, char **argv,
						int total_count);
int					collect_all_numbers(int argc, char **argv,
						char **all_numbers, int *k);
...
void				chunk_to_b(t_stack **a, t_stack **b, int chunk_size,
						int size);
